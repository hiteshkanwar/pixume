...
(function ($) {
  ...
  $.confirm = function (options) {
    ...
    if (typeof options.text === 'undefined') {
      options.text = "Are you sure you want to remove this?";
    }
    if (typeof options.confirmButton === 'undefined') {
      options.confirmButton = "Yes I am";
    }
    ...
    // Modal
    var buttons = '<button class="confirm btn btn-success" type="button" data-dismiss="modal">' + options.confirmButton + '</button>' + '<button class="cancel btn" type="button" data-dismiss="modal">' + options.cancelButton + '</button>';
    var modalHTML = '<div class="modal hide fade" tabindex="-1" role="dialog">' + '<div class="modal-body">' + options.text + '</div>' + '<div class="modal-footer">' + buttons + '</div>' + '</div>';
